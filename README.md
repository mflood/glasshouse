...
retrieved documents. It generates the answer, withholds evidence one chunk at
a time, and watches which claims change. The result is an inspectable map from
sentences to sources—not another citation badge generated by the same model.
